                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="portrait text-center col-lg-5 ">
                            <img src="assets/Maphoto.jpg" class="rounded-circle"  alt="photo img">
                        </div>
                    ...
                    <div class="col-lg-7">
                        <div class="card-body">
                            ...
                            <a class="btn btn-success btn-lg rounded mt-5" role="button" type="submit" href="public/images/Carine%20Vinagre%20dev.pdf" target="_blank">Télécharger mon CV </a>
                            ...
                            <a class="btn btn-primary btn-lg rounded mt-5" role="button"  type="submit" href="#" target="_blank">Ce projet </a>
