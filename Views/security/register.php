...
<section class="d-flex justify-content-center align-content-center w-100 h-100 ">
    <div class="m-5 rounded-3 opacity-25 bg-dark ">
        <div class="login px-5 py-2">
            ...
            <form class="form-bloc text-center " method="post"  action="register.php">
            ...
            <p class=" text-center text-warning m-3 px-3">Déjà sur mon blog ? <a href="<?= URL ?>security/login" class=" text-decoration-none">Connectez-vous</a></p>
        </div>
    </div>
